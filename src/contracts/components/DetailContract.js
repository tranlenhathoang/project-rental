				...
				<Row>
					...
					<Col md={4}>
						<div className="mt-2">
							...
							<input type="text" id="disabledTextInput" className="form-control" value={contract.customer ? contract.customer.email : ""} readOnly />
						</div>
					</Col>
					<Col md={4}>
						<div className="mt-2">
				...
				<Row className="mb-3">
					...
					<Col md={4}>
						<div className="mt-2">
							...
							<input type="text" id="disabledTextInput" className="form-control" value={contract.employee ? contract.employee.phone : ""} readOnly />
						</div>
					</Col>
					<Col md={4}>
						<div className="mt-2">
							<label className="form-label mb-1 fw-bold">Email Nhân viên:</label>
							<input type="text" id="disabledTextInput" className="form-control" value={contract.employee ? contract.employee.email : ""} readOnly />
						</div>
					</Col>
				</Row>
			</fieldset>
